...
double ax1,ax2;
double kp=0.03;// 0.091039  0.03   
double ki=0.9;// 0.338855  0.9
...
void setup(){
  ...
  attachInterrupt(digitalPinToInterrupt(encoder_a_right),dirconta,CHANGE);//cria a interrupção externa do encoder direito
  attachInterrupt(digitalPinToInterrupt(encoder_a_left),esqconta,CHANGE);//cria a interrupção externa do encoder esquerdo
